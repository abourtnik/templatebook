                    ...
                    <div class="panel-body">
                        ...
                        <!-- Name-->
                            ...
                            <div class="form-group{{ $errors->has('price') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input id="price" type="number" class="form-control" name="price" value="{{ old('price') ? old('price') : 0.0 }}"  autofocus>
                            ...
                            <div class="form-group{{ $errors->has('file') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input id="file" type="file" class="form-control" name="file" value="{{ old('price') }}"  autofocus required accept=".zip">
